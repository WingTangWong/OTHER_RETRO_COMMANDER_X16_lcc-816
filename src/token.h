...
xx(PASCAL,      87,     0,      0,      0,      STATIC, "pascal")
xx(ATTRIBUTE,   88,     0,      0,      0,      STATIC, "__attribute__")
xx(INLINE,      89,     0,      0,      0,      STATIC, "inline")
xx(NORETURN,    90,     0,      0,      0,      STATIC, "_Noreturn")
yy(0,           91,     0,      0,      0,      '[',    "[")
xx(RESTRICT,    92,     0,      0,      0,      CHAR,   "restrict")
yy(0,           93,     0,      0,      0,      ']',    "]")
