...
static void progbeg(int argc, char *argv[])
{
    ...
    for (i = 0; i < 32 - 3; ++i) {
        reg64[32-i] = mkreg("%%t%d", i, 7, 0);
        reg64[32+32-i] = mkreg("%%v%d", i, 7, 0);
        reg64[64+32-i] = mkreg("%%p%d", i, 7, 1);
    }

    for (i = 0; i < 32 - 5; ++i) {
        reg80[32-i] = mkreg("%%t%d", i, 9, 0);
        reg80[32+32-i] = mkreg("%%v%d", i, 9, 0);
        reg80[64+32-i] = mkreg("%%p%d", i, 9, 1);
    }
