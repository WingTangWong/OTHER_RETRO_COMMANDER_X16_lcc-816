...
extern pascal TimeRec ReadTimeHex(void)inline(0x0D03,dispatcher);
...
extern pascal FWRec FWEntry(Word, Word, Word, Word) inline(0x2403,dispatcher);
...
extern pascal ClampRec GetMouseClamp(void) inline(0x1D03,dispatcher);
...
extern pascal MouseRec ReadMouse(void) inline(0x1703,dispatcher);
...
extern pascal ClampRec GetAbsClamp(void) inline(0x2B03,dispatcher);
...
extern pascal Handle GetRomResource(Word, Long) inline(0x3503,dispatcher);
extern pascal MouseRec ReadMouse2(void) inline(0x3303,dispatcher);
extern pascal void ReleaseROMResource(Word, Long) inline(0x3603,dispatcher);
