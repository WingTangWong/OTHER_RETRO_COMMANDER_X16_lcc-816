...
extern pascal DeviceRec GetErrorDevice(void) inline(0x140C,dispatcher);
extern pascal Long GetInGlobals(void) inline(0x0C0C,dispatcher);
extern pascal DeviceRec GetInputDevice(void) inline(0x120C,dispatcher);
extern pascal Long GetOutGlobals (void) inline(0x0D0C,dispatcher);
extern pascal DeviceRec GetOutputDevice(void) inline(0x130C,dispatcher);
