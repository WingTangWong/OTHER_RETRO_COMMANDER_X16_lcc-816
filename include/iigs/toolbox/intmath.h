...
extern pascal LongDivRec LongDivide(Longint, Longint) inline(0x0D0B,dispatcher);
extern pascal LongMulRec LongMul(Longint, Longint) inline(0x0C0B,dispatcher);
...
extern pascal IntDivRec SDivide(Integer, Integer) inline(0x0A0B,dispatcher);
extern pascal WordDivRec UDivide(Word, Word) inline(0x0B0B,dispatcher);
