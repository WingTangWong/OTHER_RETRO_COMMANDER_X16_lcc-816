...
extern pascal void DictDelete      (pString32Ptr theText)
                                                      inline(0x0B34,dispatcher);
extern pascal pString32Ptr DictDump (pString32Ptr theText,
                                     pString32Ptr phoneticStr)
                                                      inline(0x0C34,dispatcher);
extern pascal void DictInit   (int initFlag)          inline(0x0E34,dispatcher);
extern pascal void DictInsert (pString32Ptr theText, pString32Ptr phoneticStr)
                                                      inline(0x0A34,dispatcher);
extern pascal int  Parse (pString255Ptr theText, pString255Ptr phoneticStr,
                          int firstChar)              inline(0x0934,dispatcher);
extern pascal void Say   (pString255Ptr theText)      inline(0x0F34,dispatcher);
