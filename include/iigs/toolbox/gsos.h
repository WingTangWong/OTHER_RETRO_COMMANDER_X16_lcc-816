...
#define getFormatOptions 0x0003
#define getPartitionMap 0x0004
...
extern void pascal _ ## name(parm) inline(x, 0xe100b0)

__gsos(AddNotifyProcGS, NotifyProcRecGS *, 0x2034);
__gsos(BeginSessionGS, SessionStatusRecGS *, 0x201D);
__gsos(BindIntGS, InterruptRecGS *, 0x2031);
__gsos(ChangePathGS, ChangePathRecGS *, 0x2004);
__gsos(ClearBackupBitGS, NameRecGS *, 0x200B);
__gsos(CloseGS, RefNumRecGS *, 0x2014);
__gsos(CreateGS, CreateRecGS *, 0x2001);
__gsos(DControlGS, DAccessRecGS *, 0x202E);
__gsos(DelNotifyProcGS, NotifyProcRecGS *, 0x2035);
__gsos(DestroyGS, NameRecGS *, 0x2002);
__gsos(DInfoGS, DInfoRecGS *, 0x202C);
__gsos(DReadGS, DIORecGS *, 0x202F);
__gsos(DRenameGS, DRenameRecGS *, 0x2036);
__gsos(DStatusGS, DAccessRecGS *, 0x202D);
__gsos(DWriteGS, DIORecGS *, 0x2030);
__gsos(EndSessionGS, SessionStatusRecGS *, 0x201E);
__gsos(EraseDiskGS, FormatRecGS *, 0x2025);
__gsos(ExpandPathGS, ExpandPathRecGS *, 0x200E);
__gsos(FlushGS, RefNumRecGS *, 0x2015);
__gsos(FormatGS, FormatRecGS *, 0x2024);
__gsos(FSTSpecific, void *, 0x2033);
__gsos(GetBootVolGS, GetNameRecGS *, 0x2028);
__gsos(GetDevNumberGS, DevNumRecGS *, 0x2020);
__gsos(GetDirEntryGS, DirEntryRecGS *, 0x201C);
__gsos(GetEOFGS, EOFRecGS *, 0x2019);
__gsos(GetFileInfoGS, FileInfoRecGS *, 0x2006);
__gsos(GetFSTInfoGS, FSTInfoRecGS *, 0x202B);
__gsos(GetLevelGS, LevelRecGS *, 0x201B);
__gsos(GetMarkGS, PositionRecGS *, 0x2017);
__gsos(GetNameGS, GetNameRecGS *, 0x2027);
__gsos(GetPrefixGS, PrefixRecGS *, 0x200A);
__gsos(GetRefInfoGS, RefInfoRecGS *, 0x2039);
__gsos(GetRefNumGS, GetRefNumRecGS *, 0x2038);
__gsos(GetStdRefNumGS, StdRefNumRecGS *, 0x2037);
__gsos(GetSysPrefsGS, SysPrefsRecGS *, 0x200F);
__gsos(GetVersionGS, VersionRecGS *, 0x202A);
__gsos(JudgeNameGS, JudgeNameRecGS *, 0x2007);
__gsos(NewlineGS, NewlineRecGS *, 0x2011);
__gsos(NullGS, Word *, 0x200D);
__gsos(OpenGS, OpenRecGS *, 0x2010);
__gsos(OSShutDownGS, OSShutDownRecGS *, 0x2003);
__gsos(QuitGS, QuitRecGS *, 0x2029);
__gsos(ReadGS, IORecGS *, 0x2012);
__gsos(ResetCacheGS, Word *, 0x2026);
__gsos(SessionStatusGS, SessionStatusRecGS *, 0x201F);
__gsos(SetEOFGS, SetPositionRecGS *, 0x2018);
__gsos(SetFileInfoGS, FileInfoRecGS *, 0x2005);
__gsos(SetLevelGS, LevelRecGS *, 0x201A);
__gsos(SetMarkGS, SetPositionRecGS *, 0x2016);
__gsos(SetPrefixGS, PrefixRecGS *, 0x2009);
__gsos(SetStdRefNumGS, StdRefNumRecGS *, 0x203A);
__gsos(SetSysPrefsGS, SysPrefsRecGS *, 0x200C);
__gsos(UnbindIntGS, InterruptRecGS *, 0x2032);
__gsos(VolumeGS, VolumeRecGS *, 0x2008);
__gsos(WriteGS, IORecGS *, 0x2013);
