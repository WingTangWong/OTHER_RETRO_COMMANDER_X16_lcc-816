...
/* todo -- these should have __attribute__((pascal)) ? */
...
typedef GSString(255) GSString255, *GSString255Ptr, **GSString255Hndl;
typedef GSString255Hndl *GSString255HndlPtr;

typedef GSString(32) GSString32, *GSString32Ptr, **GSString32Hndl;
