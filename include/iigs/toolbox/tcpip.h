...
*
********************************************
* 1998-12-01 MW  Original version
...
#define terrBADTRIGGERNUM 0x3621		/* Invalid trigger number */
...
extern pascal void TCPIPReconnect (displayPtr) inline(0x0C36,dispatcher);
extern pascal Long TCPIPGetMyIPAddress (void) inline(0x0F36,dispatcher);
extern pascal Word TCPIPGetConnectMethod (void) inline(0x1036,dispatcher);
extern pascal void TCPIPSetConnectMethod (Word) inline(0x1136,dispatcher);
extern pascal void TCPIPConnect (displayPtr) inline(0x1236,dispatcher);
...
extern pascal void TCPIPGetTuningTable (tunePtr) inline(0x1E36,dispatcher);
...
extern pascal void TCPIPGetUsername (unBuffPtr) inline(0x4436,dispatcher);
extern pascal void TCPIPSetUsername (char *) inline(0x4536,dispatcher);
extern pascal void TCPIPGetPassword (pwBuffPtr) inline(0x4636,dispatcher);
extern pascal void TCPIPSetPassword (char *) inline(0x4736,dispatcher);
...
extern pascal moduleListPtr TCPIPGetModuleNames (void) inline(0x4C36,dispatcher);
extern pascal void TCPIPGetHostName (hnBuffPtr) inline(0x5136,dispatcher);
extern pascal void TCPIPSetHostName (char *) inline(0x5236,dispatcher);
extern pascal void TCPIPGetLinkLayer (linkInfoBlkPtr) inline(0x5436,dispatcher);
...
extern pascal void TCPIPGetDNS (DNSRecPtr) inline(0x1C36,dispatcher);
...
extern pascal triggerProcPtr TCPIPGetUserEventTrigger (Word, Word) inline(0x6336,dispatcher);
extern pascal void TCPIPSetUserEventTrigger (Word, Word, triggerProcPtr) inline(0x6436,dispatcher);
extern pascal triggerProcPtr TCPIPGetSysEventTrigger (Word) inline(0x6536,dispatcher);
extern pascal void TCPIPSetSysEventTrigger (Word, triggerProcPtr) inline(0x6636,dispatcher);
